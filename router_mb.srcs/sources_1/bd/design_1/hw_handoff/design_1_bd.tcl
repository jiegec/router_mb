...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   CONFIG.ASSOCIATED_BUSIF {AXI_STR_TXD_0:AXI_STR_RXD_0} \
 ] $axis_clk
  set clk125M [ create_bd_port -dir O -type clk clk125M ]
  set_property -dict [ list \
